...
class FileViewedState {
  const FileViewedState(this.value);

  final String value;

  static const FileViewedState DISMISSED = FileViewedState('DISMISSED');

  static const FileViewedState UNVIEWED = FileViewedState('UNVIEWED');

  static const FileViewedState VIEWED = FileViewedState('VIEWED');

  @override
  int get hashCode => value.hashCode;
  @override
  bool operator ==(Object o) => o is FileViewedState && o.value == value;
}
